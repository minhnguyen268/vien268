...
const Users = () => {
  ...
  const GridColDef = [
    { field: "stt", headerName: t("STT"), width: 100 },
    { field: "publicId", headerName: "ID", width: 200 },
    { field: "taiKhoan", headerName: t("Tài khoản"), width: 100 },
    {
      field: "money",
    ...
    { field: "createdAt", headerName: t("Thời gian tạo"), width: 250 },
    { field: "role", headerName: t("Role"), width: 150 },
    { field: "referralUser", headerName: t("Giới thiệu bởi"), width: 150 },
    { field: "referralCount", headerName: t("Số người giới thiệu"), width: 150 },
  ...
  async function deleteAccount() {
    try {
      ...
      toast.success(t("Xóa tài khoản thành công"));
      refetch();
    } catch (error) {
      console.log(error);
      toast.error(t("Xóa tài khoản thất bại"));
    }
  }
  ...
  return (
    <>
      ...
      >
        <option value="0">{t("Tất cả")}</option>
        <option value="1">{t("Người dùng")}</option>
        <option value="2">{t("Nhân viên")}</option>
      </select>
