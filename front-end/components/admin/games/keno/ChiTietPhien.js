      ...
      >
        ...
        {dataQuery && (
          <>
            ...
            >
              {t("Tình trạng")}: {convertJSXTinhTrangGameKeno(tinhTrang)}
            </Typography>
            ...
            >
              {t("Kết quả")}: {tinhTrang === TINH_TRANG_GAME.DANG_CHO ? t("Click vào các nút để điều chỉnh kết quả") : ""}
            </Typography>
            <BoxQuay
              TYPE_GAME={TYPE_GAME}
              tinhTrang={tinhTrang}
            ...
            >
              {t("Thời gian")}: {convertDateTime(dataQuery.createdAt)}
            </Typography>
          </>
        )}
      </Box>
